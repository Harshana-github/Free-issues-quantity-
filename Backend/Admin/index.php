...
<?php if(isset($_SESSION['message'])): ?>
	...
	<div class="navbar">
		...
		<ul>
			...
			<li><a href="../../Frontend/View/view_product.php">Product</a></li>
			<li><a href="../../Frontend/View/view_customer.php">Customer</a></li>
			<li><a href="../../Frontend/View/view_free_issues.php">Free Issues</a></li>
			<li><a href="../../Frontend/View/view_placing_order.php">Placing Order</a></li>
		</ul>
	</div>
